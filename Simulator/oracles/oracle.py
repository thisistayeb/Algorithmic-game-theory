...
def get_basis_price():
  """
    "get_basis_history" ruturns a list of tuples contains (average size, average price) per days
...
def get_sharetoken_price():
    """"
        Share holders get rewarded when no prir bound exists, and each rewarded equally
